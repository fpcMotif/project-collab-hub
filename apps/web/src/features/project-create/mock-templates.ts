...
export const MOCK_PROJECT_TEMPLATES: ProjectTemplateOption[] = [
  {
    ...
    departments: DEFAULT_TEMPLATE_CONFIG.departments.map((department) => ({ ...department })),
    approvalGates: DEFAULT_TEMPLATE_CONFIG.approvalGates.map((gate) => ({ ...gate })),
  },
  {
    ...
    departments: [
      { departmentId: "dept-sales", departmentName: "商务部", isRequired: true },
      { departmentId: "dept-tech", departmentName: "技术部", isRequired: true },
      { departmentId: "dept-procurement", departmentName: "采购部", isRequired: true },
      { departmentId: "dept-logistics", departmentName: "物流部", isRequired: true },
    ],
    approvalGates: [
      {
        triggerStage: "ready",
  ...
  },
  {
    ...
    departments: [
      { departmentId: "dept-sales", departmentName: "商务部", isRequired: true },
      { departmentId: "dept-tech", departmentName: "技术部", isRequired: true },
      { departmentId: "dept-design", departmentName: "设计部", isRequired: false },
